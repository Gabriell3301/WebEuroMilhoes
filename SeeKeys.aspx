...
<form id="form1" runat="server">
    ...
    <div class="search-container d-flex justify-content-center align-items-center mb-4">
        ...
        <div class="input-group w-50">
            ...
            <div class="input-group-append">
                ...
                <%--<button id="Fake_Button" runat="server"> 
                    <i class="fa-solid fa-magnifying-glass"></i>
                </button>--%>

                <asp:button id="Button_Search" runat="server" class="btn-hidden" type="button" onclick="BtnSearch_click">
                </asp:button>
            </div>
        </div>
    ...
    <%--<script src="ScriptSeeKeys.js"></script>--%>
</body>
</html>
